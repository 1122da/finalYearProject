export const rooms = [
  {
    id: 1,
    title:
      "[New Open] Marita m81, right in front of the beach, near the couple pen line. quiet village, Rakji, and Hyeojae",
    property_type: "The Whole House",
    max_capacity: 2,
    bedrooms: 1,
    beds: 1,
    baths: 1,
  ...
  {
    id: 2,
    title: "Jeju Emotional Subsidiary Mini Mary [Mini Mary Product:]",
  ...
  },
  {
    id: 3,
    title:
      "[High Residence] Newly built studio near Gonghyang in central Shinjeju(Stemdard)",
    property_type: "whole house",
    max_capacity: 3,
    bedrooms: 1,
    beds: 2,
  ...
  },
  {
    id: 5,
    title:
      "Ju's home(2) Airport 9 km/ 2nd floor emotional subsector in front of the beach in jeju City",
    property_type: "Whole House",
    max_capacity: 4,
    bedrooms: 1,
    beds: 4,
